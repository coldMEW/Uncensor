    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "ablation_coefficients = [0.05, 0.10, 0.15]\n",
                ...
                "    print(f'Filtered search prompts to {len(search_eval_prompts)} baseline-refusing probes from {len(baseline_scores)} scanned prompts.')\n",
