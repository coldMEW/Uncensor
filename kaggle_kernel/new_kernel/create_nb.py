    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                ")\n",
                ")\n",
                "candidate_grid = list(select_diverse_candidates(candidate_grid, max_candidates=MAX_CANDIDATES))\n",
                ...
                "\n",
                "final_verification_enabled = bool(run_is_valid) and search_stop_reason in ('CONTINUE', 'CONVERGED', 'MAX_CYCLES_REACHED')\n",
                ...
                "final_verification = {'enabled': bool(final_verification_enabled), 'refusal_probe_count': len(final_verify_prompts), 'benign_control_count': len(final_verify_benign_prompts)}\n",
