    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "import time\n",
                "from src.methods import build_method_search_space, kaggle_supported_methods\n",
                ...
                "        print(f'Baseline-refusing probes below target {SEARCH_MIN_BASELINE_REFUSALS}; search will remain invalid unless evidence improves.')\n",
                "else:\n",
                "    search_stop_reason = 'INSUFFICIENT_BASELINE_REFUSALS'\n",
                ...
                "    raise RuntimeError(f'No complete sweep results collected before stop reason {search_stop_reason}.')\n",
                ...
                "candidate_results = []\n",
                "rejected_candidates = []\n",
                "candidate_search_enabled = search_stop_reason in ('CONTINUE', 'MAX_CYCLES_REACHED')\n",
                "\n",
