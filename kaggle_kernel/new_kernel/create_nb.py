    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "try:\n",
                "    splits = build_splits(\n",
                "        harmful_sources=['walledai/AdvBench', 'walledai/MaliciousInstruct', 'walledai/HarmBench'],\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "from src.optimization import build_cycle_log, build_intervention_candidates, build_run_summary, constrained_candidate_score, select_best_sweep_result\n",
                "\n",
                ...
                "expanded_layer_indices = best_layer_window_radius_3\n",
                "optimization_cycles = [\n",
                "    {\n",
                "        'cycle_index': 2,\n",
                "        'coefficient_grid': [0.10, 0.15, 0.20, 0.30, 0.40],\n",
                ...
                "    {\n",
                "        'cycle_index': 3,\n",
                "        'coefficient_grid': [0.05, 0.08, 0.10, 0.15, 0.20, 0.30],\n",
                ...
                "    {\n",
                "        'cycle_index': 4,\n",
                "        'coefficient_grid': [0.03, 0.05, 0.08, 0.10, 0.15],\n",
                "        'layer_indices': expanded_layer_indices,\n",
                "        'include_final_norm': False,\n",
                "        'direction_count': 3,\n",
                "        'layer_strategy': 'best_layer_window_radius_3',\n",
                "    },\n",
                "    {\n",
                "        'cycle_index': 5,\n",
                "        'coefficient_grid': [0.20, 0.30, 0.40, 0.50, 0.60],\n",
                "        'layer_indices': top_ranked_layers_wide,\n",
                "        'include_final_norm': False,\n",
                "        'direction_count': 3,\n",
                "        'layer_strategy': 'top_ranked_layers_wide_no_regression_expansion',\n",
                "    },\n",
                "    {\n",
                "        'cycle_index': 6,\n",
                "        'coefficient_grid': [0.20, 0.30, 0.40, 0.50, 0.60],\n",
                "        'layer_indices': best_layer_window_radius_4,\n",
                "        'include_final_norm': False,\n",
                "        'direction_count': 3,\n",
                "        'layer_strategy': 'best_layer_window_radius_4_no_regression_expansion',\n",
                "    },\n",
                "]\n",
                "\n",
                ...
                "    include_final_norm=False,\n",
                ")\n",
                "candidate_grid = candidate_grid[:18]\n",
                "candidate_eval_prompts = eval_prompts[:min(SEARCH_EVAL_LIMIT, len(eval_prompts))]\n",
                "candidate_eval_baselines = baseline_scores[:len(candidate_eval_prompts)]\n",
                "candidate_benign_prompts = benign_control_prompts[:min(SEARCH_EVAL_LIMIT, len(benign_control_prompts))]\n",
                "candidate_results = []\n",
                "rejected_candidates = []\n",
                "\n",
...
with output_path.open('w', encoding='utf-8') as f:
    json.dump(nb, f)
print(f"Notebook created with real model and HF token: {output_path}")
