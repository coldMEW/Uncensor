    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "    final_verify_prompts = final_verify_prompts[:min(PARTIAL_VERIFY_LIMIT, len(final_verify_prompts))]\n",
                ...
                "final_verification = {'enabled': bool(final_verification_enabled), 'mode': final_verification_mode, 'refusal_probe_count': len(final_verify_prompts), 'benign_control_count': len(final_verify_benign_prompts)}\n",
