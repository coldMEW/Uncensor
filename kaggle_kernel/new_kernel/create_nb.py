    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "FULL_VERIFY_REFUSAL_LIMIT = MIN_EVAL_PROMPTS\n",
                "FULL_VERIFY_BENIGN_LIMIT = MIN_BENIGN_CONTROLS\n",
                "KL_PROMPT_LIMIT = 2\n",
                "MAX_FOLLOWUP_CYCLES = 1\n",
                "MAX_NO_IMPROVEMENT_CYCLES = 1\n",
                "MAX_SEARCH_SECONDS = 2700\n",
                "MAX_CANDIDATES = 4\n",
                "MAX_GENERATION_EVALUATIONS = max(512, FULL_VERIFY_REFUSAL_LIMIT * 3 + FULL_VERIFY_BENIGN_LIMIT)\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "final_verify_prompts = eval_prompts[:min(FULL_VERIFY_REFUSAL_LIMIT, len(eval_prompts))]\n",
                "final_verify_benign_prompts = benign_control_prompts[:min(FULL_VERIFY_BENIGN_LIMIT, len(benign_control_prompts))]\n",
                ...
                "final_verification_target_refusal_count = FULL_VERIFY_REFUSAL_LIMIT\n",
                ...
                "final_verification = {'enabled': bool(final_verification_enabled), 'mode': final_verification_mode, 'refusal_probe_target': int(final_verification_target_refusal_count), 'benign_control_target': len(final_verify_benign_prompts)}\n",
                ...
                "seed_final_baseline_refusals = heldout_baseline_refusing_items[:final_verification_target_refusal_count] if final_verification_enabled else []\n",
                ...
                "final_verification.update({'refusal_probe_count': len(final_prompt_results), 'benign_control_count': len(final_benign_results)})\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "    refusal_probe_count=int(final_verification.get('refusal_probe_count', 0)),\n",
                "    benign_control_count=int(final_verification.get('benign_control_count', 0)),\n",
                "    judge_backend=judge_backend,\n",
                "    judge_is_verified=judge_is_official,\n",
                ")\n",
                ...
                "    status = 'NO_EFFECT'\n",
                "\n",
                "production_blockers = list(status_reasons)\n",
                "if not bool(metric_evidence_matrix['dataset_scale']):\n",
                "    production_blockers.append('FINAL_VERIFICATION_NOT_DATASET_SCALE')\n",
                "production_result_ok = bool(status == 'PASS' and run_is_valid and not production_blockers)\n",
                "\n",
                ...
                "search_summary['production_result_ok'] = production_result_ok\n",
                "search_summary['production_blockers'] = production_blockers\n",
                "\n",
                "results = {\n",
                "    'model': MODEL_NAME,\n",
                ...
                "    'production_result_ok': production_result_ok,\n",
