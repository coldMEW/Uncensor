    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "else:\n",
                "    print(f'Skipping final intervention verification: only {len(final_baseline_refusing_items)} baseline-refusing probes found after scanning {final_baseline_scan_count} prompts.')\n",
                "    final_verify_prompts = []\n",
                "    final_baseline_scores = []\n",
                "    final_verify_benign_prompts = []\n",
                ...
                "final_verification.update({'refusal_probe_count': len(final_verify_prompts), 'baseline_scan_count': int(final_baseline_scan_count), 'baseline_refusing_count': len(final_baseline_refusing_items), 'inconclusive': final_verification_inconclusive})\n",
