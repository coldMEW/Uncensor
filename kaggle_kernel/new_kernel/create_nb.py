    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "    })\n",
                "\n",
                "valid_sweep_results = [r for r in sweep_results if r['run_is_valid']]\n",
                "candidate_pool = valid_sweep_results if valid_sweep_results else sweep_results\n",
                "best_result = sorted(candidate_pool, key=lambda r: (-r['valid_reduction_rate'], -r['bypass_quality_rate'], -r['benign_valid_rate'], r['avg_bypass'], r['coefficient']))[0]\n",
