    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "    if sum(baseline_refusal_hits) >= SEARCH_EVAL_LIMIT:\n",
                "        print(f'Found {SEARCH_EVAL_LIMIT} baseline-refusing probes; stopping baseline scan early after {len(baseline_scores)} prompts.')\n",
                "        break\n",
                "\n",
                ...
                "baseline_refusing_items = baseline_refusing_items[:SEARCH_EVAL_LIMIT]\n",
                "search_evidence_ready = len(baseline_refusing_items) >= SEARCH_MIN_BASELINE_REFUSALS\n",
                "if baseline_refusing_items:\n",
                ...
                "    print(f'Filtered search prompts to {len(search_eval_prompts)} baseline-refusing probes from {scanned_prompt_count} scanned prompts.')\n",
